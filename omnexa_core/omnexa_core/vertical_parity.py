...
def _default_handler(scenario: str, params: dict) -> dict:
	return {"kpi": {}, "note": "default_preview"}
...
def _trading(scenario: str, params: dict) -> dict:
	...
	return {"kpi": {"route_sales_total": total, "line_count": len(lines)}, "sap_module": "SD"}
...
def _healthcare(scenario: str, params: dict) -> dict:
	...
	return {"kpi": {"billable": fees, "copay": copay, "net_receivable": fees - copay}, "sap_module": "IS-H"}
...
def _education(scenario: str, params: dict) -> dict:
	...
	return {"kpi": {"total_fees": students * fee, "students": students}, "sap_module": "IS-HER"}
...
def _construction(scenario: str, params: dict) -> dict:
	...
	return {"kpi": {"ipc_amount": ipc, "completed_percent": pct * 100}, "sap_module": "PS/E&C"}
...
def _agriculture(scenario: str, params: dict) -> dict:
	...
	return {"kpi": {"estimated": estimated, "actual": actual, "variance": variance}, "sap_module": "LO-AGR"}
...
def _car_rental(scenario: str, params: dict) -> dict:
	...
	return {"kpi": {"fleet_size": fleet, "rented": rented, "utilization": util}, "sap_module": "TM"}
...
def _projects_pm(scenario: str, params: dict) -> dict:
	...
	cpi = round(ev / ac, 4)
	return {"kpi": {"spi": spi, "cpi": cpi, "pv": pv, "ev": ev, "ac": ac}, "sap_module": "PS"}
...
def _customer_core(scenario: str, params: dict) -> dict:
	...
	return {"kpi": {"weighted_pipeline": weighted, "stage_count": len(stages)}, "sap_module": "CRM"}
