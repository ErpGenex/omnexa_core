...
def _n8n(_s: str, params: dict) -> dict:
	...
	return {"kpi": {"pending_events": events, "failed_deliveries": failed
	}, "sap_module": "BTP-INT"
	}
...
def _intelligence(_s: str, params: dict) -> dict:
	...
	return {"kpi": {"active_signals": signals, "avg_confidence": confidence
	}, "sap_module": "BTP-AI"
	}
...
def _academy(_s: str, params: dict) -> dict:
	...
	return {"kpi": {"published_guides": guides
	}, "sap_module": "LSO"
	}
...
def _theme(_s: str, params: dict) -> dict:
	...
	return {"kpi": {"theme_active": active
	}, "sap_module": "Fiori"
	}
