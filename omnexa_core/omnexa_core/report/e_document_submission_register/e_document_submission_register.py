...
def execute(filters=None):
	data = frappe.db.sql(
		"""
		SELECT `name`, `company`, `branch`, `authority_status`
		FROM `tabE-Document Submission`
	...
	columns = [
		...
		{"label": _("Authority Status"), "fieldname": "authority_status", "fieldtype": "Select", "width": 120}
	]
	return columns, data
