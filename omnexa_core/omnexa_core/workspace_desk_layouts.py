...
# Global car rental / ACRISS + ISO 39001 journey — mirrors omnexa_car_rental.workspace.car_rental_workspace.
CAR_RENTAL_DESK: list[DeskSection] = [
	(
		"Dashboards & portals",
		[
			("Executive Dashboard", "Page", "car-rental-executive-dashboard", None),
			("Online Booking Desk", "Page", "car-rental-booking-desk", None),
			("Customer Portal", "Page", "car-rental-customer-portal", None),
			("Agent Tablet", "Page", "car-rental-agent-tablet", None),
			("Walk-In Kiosk", "Page", "car-rental-walk-in-kiosk", None),
			("Workshop Vendor", "Page", "car-rental-workshop-vendor-portal", None),
			("Predictive Analytics", "Page", "car-rental-predictive-analytics", None),
			("Franchise Dashboard", "Page", "car-rental-franchise-dashboard", None),
		],
	),
	(
		"Fleet & catalog",
		[
			...
			("Vehicle Group", "DocType", "Rental Vehicle Group", None),
			("Rental Station", "DocType", "Rental Station", None),
			("Supplier Fleet Contract", "DocType", "Supplier Fleet Contract", None),
			("Insurance Policy", "DocType", "Vehicle Insurance Policy", None),
		],
	),
	(
		"Reservations & pricing",
		[
			("Rate Plan", "DocType", "Rental Rate Plan", None),
			("Extra Services", "DocType", "Rental Extra Service", None),
			("Rental Booking", "DocType", "Rental Booking", None),
			("Rental Contract", "DocType", "Rental Contract", None),
			("Vehicle Inspection", "DocType", "Rental Vehicle Inspection", None),
			("Group Booking", "DocType", "Rental Group Booking", None),
			("Subscription Plan", "DocType", "Rental Subscription Plan", None),
			("Franchise Agent", "DocType", "Rental Franchise Agent", None),
			("OTA Channel", "DocType", "Rental OTA Channel", None),
			("E-Signature", "DocType", "Rental Contract Signature", None),
			("Contract Version", "DocType", "Rental Contract Version", None),
			("Leasing Template", "DocType", "Rental Leasing Template", None),
			("Contract Approval", "DocType", "Rental Contract Approval", None),
		],
	),
	(
		"Customers & drivers",
		[
			...
			("Corporate Account", "DocType", "Rental Corporate Account", None),
			("Loyalty Tier", "DocType", "Rental Loyalty Tier", None),
			("Customer Wallet", "DocType", "Rental Customer Wallet", None),
			("Blacklist", "DocType", "Rental Customer Blacklist", None),
			("CRM Campaign", "DocType", "Rental CRM Campaign", None),
			("Driver Violation", "DocType", "Rental Driver Violation", None),
			("Driver Training", "DocType", "Rental Driver Training", None),
		],
	),
	(
		"Maintenance & risk",
		[
			("Work Order", "DocType", "Maintenance Work Order", None),
			("Maintenance Record", "DocType", "Vehicle Maintenance Record", None),
			("Fuel Log", "DocType", "Vehicle Fuel Log", None),
			("Damage Report", "DocType", "Vehicle Damage Report", None),
			("Preventive Schedule", "DocType", "Rental Preventive Schedule", None),
			("Predictive Alert", "DocType", "Rental Predictive Alert", None),
			("Insurance Claim", "DocType", "Rental Insurance Claim", None),
			("Warranty Claim", "DocType", "Rental Warranty Claim", None),
			("Downtime SLA", "DocType", "Rental Downtime SLA", None),
			("Spare Parts", "DocType", "Rental Spare Part", None),
		],
	),
	(
		"Telematics & lifecycle",
		[
			("GPS Track", "DocType", "Vehicle GPS Track", None),
			("Geofence Zone", "DocType", "Rental Geofence Zone", None),
			("EV Charging", "DocType", "EV Charging Session", None),
			("Fuel IoT", "DocType", "Rental Fuel IoT Reading", None),
			("Acquisition", "DocType", "Vehicle Acquisition", None),
			("Disposal", "DocType", "Vehicle Disposal", None),
			("Tire Record", "DocType", "Vehicle Tire Record", None),
			("Revenue Recognition", "DocType", "Rental Revenue Recognition", None),
			("Country Pack", "DocType", "Rental Country Pack", None),
			("DR Runbook", "DocType", "Rental DR Runbook", None),
			("ISO Controls", "DocType", "Rental ISO Control", None),
		],
	),
	(
		"Tolls & road charges",
		[
			...
			("Allocation Rule", "DocType", "Toll Allocation Rule", None),
	...
	(
		...
		[
			...
			("Maintenance Cost", "Report", "Maintenance Cost Analysis", "Vehicle Maintenance Record"),
			("Fuel & Energy", "Report", "Fuel & Energy Cost Summary", "Vehicle Fuel Log"),
		],
	),
	(
		"Reports · Operations",
		[
			...
			("Cost Per Vehicle Day", "Report", "Cost Per Vehicle Day", "Rental Contract"),
		],
	),
]
